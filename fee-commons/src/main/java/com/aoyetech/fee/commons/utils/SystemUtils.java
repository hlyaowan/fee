...
public class SystemUtils {
     ...
     * @since 3.1
     */
    public static final boolean      IS_OS_WINDOWS_2003                  = getOSMatches(
                                                                                 OS_NAME_WINDOWS_PREFIX,
                                                                                 "5.2");
     ...
     * @since 3.1
     */
    public static final boolean      IS_OS_WINDOWS_2008                  = getOSMatches(
                                                                                 OS_NAME_WINDOWS_PREFIX
                                                                                         + " Server 2008",
                                                                                 "6.1");
    ...
    public static int getSystemPropertyAsInt(final String property, final int defaultValue) {
        try {
    ...
    public static boolean getSystemPropertyAsBool(final String property, final boolean defaultValue) {
        try {
            final String valueString = System.getProperty(property).trim();
